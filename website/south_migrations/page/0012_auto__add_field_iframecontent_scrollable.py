...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IframeContent.scrollable'
        db.add_column(u'page_page_iframecontent', 'scrollable',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'IframeContent.scrollable'
        db.delete_column(u'page_page_iframecontent', 'scrollable')
