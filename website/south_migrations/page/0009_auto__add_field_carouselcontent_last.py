...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CarouselContent.last'
        db.add_column(u'page_page_carouselcontent', 'last',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CarouselContent.last'
        db.delete_column(u'page_page_carouselcontent', 'last')
    ...
    models = {
        ...
        u'page.page': {
            ...
            'publication_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 10, 0, 0)'}),
