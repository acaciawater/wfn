...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CarouselContent.background'
        db.add_column(u'page_page_carouselcontent', 'background',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'page_carouselcontent_background_set', null=True, to=orm['medialibrary.MediaFile']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CarouselContent.background'
        db.delete_column(u'page_page_carouselcontent', 'background_id')
