...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Page.intro_text'
        db.add_column(u'page_page', 'intro_text',
                      self.gf('django.db.models.fields.TextField')(default='', null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Page.intro_text'
        db.delete_column(u'page_page', 'intro_text')
    ...
    models = {
        ...
        u'page.filteredpublicationcontent': {
            ...
            'category': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "u'page_filteredpublicationcontent_set'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['website.PublicationCategory']"}),
            'count': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'page.iframecontent': {
            ...
            'region': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'scrollable': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        u'page.page': {
            ...
            'intro_text': ('django.db.models.fields.TextField', [], {'default': "''", 'null': 'True', 'blank': 'True'}),
            'language': ('django.db.models.fields.CharField', [], {'default': "'en'", 'max_length': '10'}),
            u'level': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            u'lft': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'main_image': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'to': u"orm['medialibrary.MediaFile']", 'null': 'True', 'blank': 'True'}),
            ...
            'publication_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 22, 0, 0)'}),
