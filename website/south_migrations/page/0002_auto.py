...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field category on 'FilteredPublicationContent'
        m2m_table_name = db.shorten_name(u'page_page_filteredpublicationcontent_category')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('filteredpublicationcontent', models.ForeignKey(orm[u'page.filteredpublicationcontent'], null=False)),
            ('publicationcategory', models.ForeignKey(orm[u'website.publicationcategory'], null=False))
        ))
        db.create_unique(m2m_table_name, ['filteredpublicationcontent_id', 'publicationcategory_id'])


    def backwards(self, orm):
        # Removing M2M table for field category on 'FilteredPublicationContent'
        db.delete_table(db.shorten_name(u'page_page_filteredpublicationcontent_category'))
