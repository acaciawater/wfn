...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PageLinkContent'
        db.create_table(u'page_page_pagelinkcontent', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(related_name='pagelinkcontent_set', to=orm['page.Page'])),
            ('region', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('ordering', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'page_pagelinkcontent_set', to=orm['page.Page'])),
        ))
        db.send_create_signal(u'page', ['PageLinkContent'])

        # Adding field 'Page.main_image'
        db.add_column(u'page_page', 'main_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['medialibrary.MediaFile']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'PageLinkContent'
        db.delete_table(u'page_page_pagelinkcontent')

        # Deleting field 'Page.main_image'
        db.delete_column(u'page_page', 'main_image_id')
    ...
    models = {
        ...
        u'page.buttoncontent': {
            'Meta': {'ordering': "['ordering']", 'object_name': 'ButtonContent', 'db_table': "u'page_page_buttoncontent'"},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'link': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'link_text': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'ordering': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'buttoncontent_set'", 'to': u"orm['page.Page']"}),
            'region': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
        u'page.carouselcontent': {
            'Meta': {'ordering': "['ordering']", 'object_name': 'CarouselContent', 'db_table': "u'page_page_carouselcontent'"},
            'background': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'page_carouselcontent_background_set'", 'null': 'True', 'to': u"orm['medialibrary.MediaFile']"}),
            'header': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'page.iframecontent': {
            'Meta': {'ordering': "['ordering']", 'object_name': 'IframeContent', 'db_table': "u'page_page_iframecontent'"},
            'height': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ordering': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'iframecontent_set'", 'to': u"orm['page.Page']"}),
            'region': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
        ...
        u'page.page': {
            ...
            'main_image': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'to': u"orm['medialibrary.MediaFile']"}),
            ...
            'publication_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 16, 0, 0)'}),
        ...
        u'page.pagelinkcontent': {
            'Meta': {'ordering': "['ordering']", 'object_name': 'PageLinkContent', 'db_table': "u'page_page_pagelinkcontent'"},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ordering': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'page': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'page_pagelinkcontent_set'", 'to': u"orm['page.Page']"}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'pagelinkcontent_set'", 'to': u"orm['page.Page']"}),
            'region': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
        ...
        u'page.storycontent': {
            ...
            'image_mask': ('django.db.models.fields.CharField', [], {'default': "'mask-1'", 'max_length': '100'}),
            'image_position': ('django.db.models.fields.CharField', [], {'default': "'drop'", 'max_length': '100'}),
            'link': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'link_text': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'ordering': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
