...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Page.main_image'
        db.alter_column(u'page_page', 'main_image_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['medialibrary.MediaFile'], null=True))

    def backwards(self, orm):

        # Changing field 'Page.main_image'
        db.alter_column(u'page_page', 'main_image_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['medialibrary.MediaFile']))
