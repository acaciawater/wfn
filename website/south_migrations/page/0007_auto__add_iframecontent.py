...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'IframeContent'
        db.create_table(u'page_page_iframecontent', (
            ...
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(related_name='iframecontent_set', to=orm['page.Page'])),
            ('region', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('ordering', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'page', ['IframeContent'])


    def backwards(self, orm):
        # Deleting model 'IframeContent'
        db.delete_table(u'page_page_iframecontent')
    ...
    models = {
        ...
        u'page.page': {
            ...
            'publication_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 6, 0, 0)'}),
