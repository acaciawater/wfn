...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ReportContent.header'
        db.add_column(u'page_page_reportcontent', 'header',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ReportContent.header'
        db.delete_column(u'page_page_reportcontent', 'header')
    ...
    models = {
        ...
        u'page.page': {
            ...
            'publication_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 17, 0, 0)'}),
