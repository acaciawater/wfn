...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ButtonContent'
        db.create_table(u'page_page_buttoncontent', (
            ...
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(related_name='buttoncontent_set', to=orm['page.Page'])),
            ('region', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('ordering', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'page', ['ButtonContent'])

        # Deleting field 'CarouselContent.link'
        db.delete_column(u'page_page_carouselcontent', 'link')


    def backwards(self, orm):
        # Deleting model 'ButtonContent'
        db.delete_table(u'page_page_buttoncontent')


        # User chose to not deal with backwards NULL issues for 'CarouselContent.link'
        raise RuntimeError("Cannot reverse this migration. 'CarouselContent.link' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'CarouselContent.link'
        db.add_column(u'page_page_carouselcontent', 'link',
    ...
    models = {
        ...
        u'page.page': {
            ...
            'publication_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 7, 0, 0)'}),
