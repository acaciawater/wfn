...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StoryContent.image_mask'
        db.add_column(u'page_page_storycontent', 'image_mask',
                      self.gf('django.db.models.fields.CharField')(default='mask-1', max_length=100),
                      keep_default=False)

        # Adding field 'StoryContent.image_position'
        db.add_column(u'page_page_storycontent', 'image_position',
                      self.gf('django.db.models.fields.CharField')(default='drop', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StoryContent.image_mask'
        db.delete_column(u'page_page_storycontent', 'image_mask')

        # Deleting field 'StoryContent.image_position'
        db.delete_column(u'page_page_storycontent', 'image_position')
    ...
    models = {
        ...
        u'page.page': {
            ...
            'publication_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 3, 0, 0)'}),
