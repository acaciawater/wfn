...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CarouselLinks'
        db.create_table(u'website_carousellinks', (
        ...
        db.send_create_signal(u'website', ['CarouselLinks'])


    def backwards(self, orm):
        # Deleting model 'CarouselLinks'
        db.delete_table(u'website_carousellinks')
