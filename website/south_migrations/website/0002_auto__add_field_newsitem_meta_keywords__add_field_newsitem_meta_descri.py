...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'website_newsitem', 'meta_keywords',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'NewsItem.meta_description'
        db.add_column(u'website_newsitem', 'meta_description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Event.meta_keywords'
        db.add_column(u'website_event', 'meta_keywords',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Event.meta_description'
        db.add_column(u'website_event', 'meta_description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'website_newsitem', 'meta_keywords')

        # Deleting field 'NewsItem.meta_description'
        db.delete_column(u'website_newsitem', 'meta_description')

        # Deleting field 'Event.meta_keywords'
        db.delete_column(u'website_event', 'meta_keywords')

        # Deleting field 'Event.meta_description'
        db.delete_column(u'website_event', 'meta_description')
