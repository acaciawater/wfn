...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'website_people', 'phone', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'People.phone'
        db.alter_column(u'website_people', 'phone', self.gf('django.db.models.fields.EmailField')(max_length=200, null=True))
