...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Publication.require_registration'
        db.add_column(u'website_publication', 'require_registration',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Publication.require_registration'
        db.delete_column(u'website_publication', 'require_registration')
    ...
    models = {
        ...
        u'website.publication': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'language': ('django.db.models.fields.CharField', [], {'default': "'en'", 'max_length': '10'}),
            'require_registration': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
