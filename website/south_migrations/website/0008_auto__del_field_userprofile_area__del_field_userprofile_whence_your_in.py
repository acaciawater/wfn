...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'website_userprofile', 'area')

        # Deleting field 'UserProfile.whence_your_interest'
        db.delete_column(u'website_userprofile', 'whence_your_interest')

        # Adding field 'UserProfile.organisation'
        db.add_column(u'website_userprofile', 'organisation',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.country'
        db.add_column(u'website_userprofile', 'country',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.newsletter'
        db.add_column(u'website_userprofile', 'newsletter',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'UserProfile.updates_tool_developments'
        db.add_column(u'website_userprofile', 'updates_tool_developments',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'website_userprofile', 'area',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.whence_your_interest'
        db.add_column(u'website_userprofile', 'whence_your_interest',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'UserProfile.organisation'
        db.delete_column(u'website_userprofile', 'organisation')

        # Deleting field 'UserProfile.country'
        db.delete_column(u'website_userprofile', 'country')

        # Deleting field 'UserProfile.newsletter'
        db.delete_column(u'website_userprofile', 'newsletter')

        # Deleting field 'UserProfile.updates_tool_developments'
        db.delete_column(u'website_userprofile', 'updates_tool_developments')
    ...
    models = {
        ...
        u'website.userprofile': {
            ...
            'updates_tool_developments': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
